"""
Usage: distroinfo fetch [-C <cache-dir>] [-f remote|git|local] <info-url> <info-file>...
       distroinfo dump [-y <out.yaml>] [-j <out.json>] [-C <cache-dir>] [-f remote|git|local] <info-url> <info-file>...
       distroinfo --help | --version
